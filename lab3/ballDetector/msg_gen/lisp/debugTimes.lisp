...
(cl:defmethod cl:initialize-instance :after ((m <debugTimes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'debugTimes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ballDetector-msg:<debugTimes> is deprecated: use ballDetector-msg:debugTimes instead.")))
...
(cl:defmethod labels-val ((m <debugTimes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ballDetector-msg:labels-val is deprecated.  Use ballDetector-msg:labels instead.")
  (labels m))

(cl:ensure-generic-function 'times-val :lambda-list '(m))
(cl:defmethod times-val ((m <debugTimes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ballDetector-msg:times-val is deprecated.  Use ballDetector-msg:times instead.")
  (times m))
