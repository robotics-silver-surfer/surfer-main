...
(cl:defmethod cl:initialize-instance :after ((m <ballDebug>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ballDebug)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ballDetector-msg:<ballDebug> is deprecated: use ballDetector-msg:ballDebug instead.")))

(cl:ensure-generic-function 'sendDebugImages-val :lambda-list '(m))
(cl:defmethod sendDebugImages-val ((m <ballDebug>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ballDetector-msg:sendDebugImages-val is deprecated.  Use ballDetector-msg:sendDebugImages instead.")
  (sendDebugImages m))

(cl:ensure-generic-function 'sendDebugTimes-val :lambda-list '(m))
(cl:defmethod sendDebugTimes-val ((m <ballDebug>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ballDetector-msg:sendDebugTimes-val is deprecated.  Use ballDetector-msg:sendDebugTimes instead.")
  (sendDebugTimes m))
