...
(cl:in-package landmarkSelfSim-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <landmarkLocation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'landmarkLocation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name landmarkSelfSim-msg:<landmarkLocation> is deprecated: use landmarkSelfSim-msg:landmarkLocation instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:header-val is deprecated.  Use landmarkSelfSim-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'xtop-val :lambda-list '(m))
(cl:defmethod xtop-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:xtop-val is deprecated.  Use landmarkSelfSim-msg:xtop instead.")
  (xtop m))

(cl:ensure-generic-function 'ytop-val :lambda-list '(m))
(cl:defmethod ytop-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:ytop-val is deprecated.  Use landmarkSelfSim-msg:ytop instead.")
  (ytop m))

(cl:ensure-generic-function 'xbottom-val :lambda-list '(m))
(cl:defmethod xbottom-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:xbottom-val is deprecated.  Use landmarkSelfSim-msg:xbottom instead.")
  (xbottom m))

(cl:ensure-generic-function 'ybottom-val :lambda-list '(m))
(cl:defmethod ybottom-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:ybottom-val is deprecated.  Use landmarkSelfSim-msg:ybottom instead.")
  (ybottom m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:height-val is deprecated.  Use landmarkSelfSim-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <landmarkLocation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader landmarkSelfSim-msg:code-val is deprecated.  Use landmarkSelfSim-msg:code instead.")
  (code m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<landmarkLocation>)))
  ...
  "landmarkSelfSim/landmarkLocation")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'landmarkLocation)))
  "Returns string type for a message object of type 'landmarkLocation"
  "landmarkSelfSim/landmarkLocation")
