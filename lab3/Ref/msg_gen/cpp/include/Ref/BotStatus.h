/* Auto-generated by genmsg_cpp for file /projects/ros/surfer-main/lab3/Ref/msg/BotStatus.msg */
...
struct MD5Sum< ::Ref::BotStatus_<ContainerAllocator> > {
  ...
  {
    return "742eab62fbe4b8a5d8451d3c2f43cb20";
  }

  static const char* value(const  ::Ref::BotStatus_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x742eab62fbe4b8a5ULL;
  static const uint64_t static_value2 = 0xd8451d3c2f43cb20ULL;
};
...
s << std::endl;
    ...
    s << indent << "lap: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.lap);
    s << indent << "powerUp: ";
