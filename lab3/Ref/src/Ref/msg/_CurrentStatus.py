"""autogenerated by genpy from Ref/CurrentStatus.msg. Do not edit."""
import sys
...
class CurrentStatus(genpy.Message):
  _md5sum = "6e45f36f38d7d698ab2f081fcb41b647"
  _type = "Ref/CurrentStatus"
...
"""
  __slots__ = ['header','positions','checkpoints']
  _slot_types = ['std_msgs/Header','Ref/Position[]','Ref/Position[]']
