...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arbitrator-msg:<Control> is deprecated: use arbitrator-msg:Control instead.")))
...
(cl:defmethod state-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arbitrator-msg:state-val is deprecated.  Use arbitrator-msg:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Control>)))
  ...
  (cl:format cl:nil "Header header~%~%#Control state~%#  0 = manual~%#  1 = automatic~%#  2 = triangle~%#  3 = right turn~%#  4 = left turn~%uint8 state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Control)))
  "Returns full string definition for message of type 'Control"
  (cl:format cl:nil "Header header~%~%#Control state~%#  0 = manual~%#  1 = automatic~%#  2 = triangle~%#  3 = right turn~%#  4 = left turn~%uint8 state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
